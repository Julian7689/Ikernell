...
export default function ChatsContennt(){
    return(
                    ...
                    <div className='flex items-center justify-between'>
                        <div>
                            <div className="flex items-center space-x-2 mb-2">
                                <span className="text-white/60 text-4xl font-light">Conversaciones</span>
                                
                            </div>
                            <p className="text-white/80 text-xl mb-6">Chats y conversaciones </p>
